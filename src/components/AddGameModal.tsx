...
type Props = {
    ...
    onSubmitButton?: "addGameFunction" | "updateGameFunction";
}
export default function AddGameModal({gameListTitle, buttonVariant, buttonIcon, buttonName, modalDetails, onSubmitButton}: Props) {
    //asChild meaning handle as child yung component instead yung default
    const [inputFieldsToAddGame, setInputFieldsToAddGame] = useState({
        gameImage: '',
        gameTitle: '',
        weeklyPrice: 0,
        monthlyPrice: 0,
    ...
    async function updateGameFunction() {
        console.log("update game function")
    }
            ...
            <form>
                ...
                <DialogContent className="sm:max-w-sm">
                    ...
                    <DialogFooter>
                        ...
                        <DialogClose asChild>
                            <Button type="submit" onClick={onSubmitButton === 'addGameFunction' ? addGameFunction : updateGameFunction}>{modalDetails.submitButtonName}</Button>
                        </DialogClose>
                    </DialogFooter>
                </DialogContent>
            </form>
